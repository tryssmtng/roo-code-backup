...
const SettingsView = forwardRef<SettingsViewRef, SettingsViewProps>(({ onDone }, ref) => {
	...
	const handleSubmit = () => {
		if (isSettingValid) {
			...
			vscode.postMessage({ type: "promptAutoEnhanceEnabled", bool: promptAutoEnhanceEnabled })
			vscode.postMessage({ type: "autoSpeakEnabled", bool: autoSpeakEnabled })
			vscode.postMessage({ type: "autoSpeakVoiceModel", text: autoSpeakVoiceModel || "alloy" })
			...
			<TabContent className="p-0 divide-y divide-vscode-sideBar-background" onScroll={handleScroll}>
				...
				<div ref={notificationsRef}>
					<NotificationSettings
						...
						autoSpeakVoiceModel={autoSpeakVoiceModel}
						setCachedStateField={setCachedStateField}
					/>
				</div>
				...
				<div ref={advancedRef}>
					<AdvancedSettings
						...
						promptAutoEnhanceEnabled={promptAutoEnhanceEnabled}
