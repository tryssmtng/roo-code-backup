...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	...
	const contextValue: ExtensionStateContextType = {
		...
		setPromptAutoEnhanceEnabled: (value) => setState((prevState) => ({ ...prevState, promptAutoEnhanceEnabled: value })),
		setAutoSpeakEnabled: (value) => setState((prevState) => ({ ...prevState, autoSpeakEnabled: value })),
		setAutoSpeakVoiceModel: (value) => setState((prevState) => ({ ...prevState, autoSpeakVoiceModel: value })),
	}
